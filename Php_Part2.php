...
<body>
    ...
    <form id="wordFrequencyForm" method="post" action="">
        ...
        <textarea id="text" name="text" rows="10" cols="50" required><?php if(isset($_POST['text'])) echo htmlspecialchars($_POST['text']); ?></textarea><br><br>
        ...
        <input type="number" id="limit" name="limit" value="<?php if(isset($_POST['limit'])) echo htmlspecialchars($_POST['limit']); ?>" min="1"><br><br>
    ...
    if(isset($_POST['submit'])) {
        ...
        function calculateWordFrequency($text) {
            $stopWords = array("to", "our", "in", "we", "is", "of", "for", "then", "my", "the", "and", "a", "on"); 
